...
export const deDE = {
  ...
  research: {
    ...
    contextLevelSelector: "Kontext",
    savePreference: "Präferenz speichern",
    savingPreference: "Speichern…",
    ...
    modelRequiredHint: "Bitte Modell auswählen.",
    ...
    transformations: {
      ...
      citations: "Zitate",
      egressTitle: "Hinweis zur Datenweitergabe",
      egressMessage: "Die Ausführung sendet die ausgewählten Eingaben an den konfigurierten Modelldienst. Das Modell kann ein externer Dienst sein; stellen Sie sicher, dass es von einem Administrator genehmigt wurde.",
