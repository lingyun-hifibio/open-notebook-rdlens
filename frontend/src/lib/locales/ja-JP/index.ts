...
export const jaJP = {
  ...
  research: {
    ...
    modelSelector: "モデル",
    contextLevelSelector: "コンテキスト",
    savePreference: "設定を保存",
    savingPreference: "保存中…",
    ...
    modelRequiredHint: "モデルを選択してください。",
    ...
    transformations: {
      ...
      citations: "引用",
      egressTitle: "データ外部送信の通知",
      egressMessage: "変換を実行すると、選択した入力が設定済みのモデルサービスに送信されます。モデルは外部サービスの可能性があります。管理者の承認を確認してください。",
      confirmRun: "実行",
    },
  },
