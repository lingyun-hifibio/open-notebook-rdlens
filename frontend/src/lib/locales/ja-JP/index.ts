...
export const jaJP = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "回答を生成中…",
    coverage: {
      scopeLabel: "回答範囲",
      scopeRelevant: "関連証拠による回答",
      scopeAllSelected: "選択したすべてのソースをカバー",
      capabilityDisabled: "この環境では「選択したすべてのソースをカバー」は有効になっていません。",
      notesNotSupported: "現段階では Notes に対する「すべてのソースをカバー」は未対応です。Notes の選択を解除してください。",
      noSourcesHint: "ソースを 1 つ以上選択してください。",
      entireProjectNotice: "Coverage runs on a selected Source set — switch to Selected sources to use it.",
      tooManySources: "カバーできるのは最大 {{max}} 件のソースです（現在 {{count}} 件選択）。",
      syncing: "タスク受理済み — 状態を同期中…",
      targetCoverage: "対象カバレッジ",
      requested: "計画",
      analyzed: "分析済み",
      failed: "失敗",
      status: { complete: "完了", partial: "部分完了", failed: "失敗" },
      perDocument: "ソース別ステータス",
      revision: "リビジョン",
      verificationVerified: "検証済み",
      verificationCriticIssues: "レビュー指摘あり",
      verificationDegraded: "劣化",
      verificationLabel: "検証ステータス",
      criticIssuesCount: "レビュー待ち {{count}} 件",
      outcomeUnknown: "結果不明 — 手動対応が必要です",
      outcomeUnknownDetail: "リクエストはモデルで処理され課金された可能性があります。システムは自動再送しません。",
      retry: "カバレッジを再実行",
      retryTitle: "カバレッジを再実行しますか？",
      retryBillingRisk: "前回の実行の結果は不明で、課金されている可能性があります。再実行すると新しい実行が作成され、再度課金される場合があります。",
      retryConfirm: "再実行を確認",
      retryCancel: "キャンセル",
      retrying: "再実行中…",
      retryFailed: "再実行に失敗しました。エラーを確認して再試行してください。",
      fixedSnapshot: "送信時に固定されたソーススナップショット",
      finalReport: "最終レポート",
    },
    sourceChat: {
      title: "Source chat",
    ...
    globalModel: {
      ...
      clear: "クリア",
      saveFailed: "保存に失敗",
      unavailable: "保存済みモデルは利用できません",
      selectModelHint: "生成を実行する前に研究モデルを選択してください。",
      draftUnsaved: "未保存の選択",
    ...
    searchContext: {
      ...
      save: "検索コンテキストを保存",
      saving: "保存中…",
      autoAdjusted: "現在のモデルは {{level}} コンテキストに対応していないため、focused に切り替えました。",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "この環境では「選択したすべてのソースをカバー」が有効ではないため、リクエストは送信されませんでした。「関連する証拠に基づく回答」を使用するか、管理者に有効化を依頼してください。",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "レポートを表示",
    compareReportHide: "レポートを隠す",
    compareReportLoading: "レポートを読み込み中…",
    compareReportError: "レポートはまだ利用できません",
    ...
    workbench: {
      ...
      exportAll: "研究成果物をエクスポート",
      exportCreated: "エクスポートを作成しました",
      exportDownloading: "エクスポートをダウンロード中…",
      exportFailed: "エクスポートに失敗しました",
      empty: "まだ何もありません",
      noteCreated: "ノートを作成しました",
      noteUpdated: "ノートを更新しました",
      noteDeleted: "ノートを削除しました",
      insightCreated: "インサイトを保存しました",
      transformationCreated: "テンプレートを作成しました",
    },
    sources: {
      statusPending: "同期中",
      statusReady: "準備完了",
    ...
    citation: {
      page: "{{page}} ページ",
      jump: "ソースへ移動",
      degradedSource: "ソースファイルを利用できません。原文は保持されています",
      degradedVersion: "参照バージョンは利用できなくなりました。原文は保持されています",
      degradedPage: "参照ページを利用できません。原文は保持されています",
    },
    notes: {
      newNote: "新しいノート",
      titleLabel: "タイトル",
    ...
    transformations: {
      ...
      scopePrivate: "プロジェクト非公開",
      scopeAdmin: "管理者テンプレート",
      save: "テンプレートを保存",
      run: "実行",
