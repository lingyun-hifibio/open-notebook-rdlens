...
export const frFR = {
  ...
  research: {
    ...
    modelSelector: "Modèle",
    contextLevelSelector: "Contexte",
    savePreference: "Enregistrer la préférence",
    savingPreference: "Enregistrement…",
    ...
    modelRequiredHint: "Sélectionnez un modèle.",
    ...
    transformations: {
      ...
      citations: "Citations",
      egressTitle: "Avis de transfert de données",
      egressMessage: "L’exécution envoie les entrées sélectionnées au service de modèle configuré. Le modèle peut être un service externe ; assurez-vous qu’il est approuvé par l’administrateur.",
      confirmRun: "Exécuter",
    },
  },
