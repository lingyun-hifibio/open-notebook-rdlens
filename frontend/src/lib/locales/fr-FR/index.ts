...
export const frFR = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "Génération de la réponse…",
    coverage: {
      scopeLabel: "Portée de la réponse",
      scopeRelevant: "Réponse avec preuves pertinentes",
      scopeAllSelected: "Couvrir toutes les sources sélectionnées",
      capabilityDisabled: "Couvrir toutes les sources sélectionnées n'est pas activé sur ce déploiement.",
      notesNotSupported: "Couvrir toutes les sources sélectionnées n'est pas pris en charge pour les Notes dans cette phase — désélectionnez les Notes pour l'utiliser.",
      noSourcesHint: "Sélectionnez au moins une source.",
      entireProjectNotice: "Coverage runs on a selected Source set — switch to Selected sources to use it.",
      tooManySources: "Au maximum {{max}} sources peuvent être couvertes ({{count}} sélectionnées).",
      syncing: "Tâche acceptée — synchronisation de l'état…",
      targetCoverage: "Couverture cible",
      requested: "Prévu",
      analyzed: "Analysées",
      failed: "Échouées",
      status: { complete: "Complet", partial: "Partiel", failed: "Échoué" },
      perDocument: "État par source",
      revision: "Révision",
      verificationVerified: "Vérifié",
      verificationCriticIssues: "Points de revue",
      verificationDegraded: "Dégradé",
      verificationLabel: "Vérification",
      criticIssuesCount: "{{count}} point(s) à revoir",
      outcomeUnknown: "Résultat inconnu — examen manuel requis",
      outcomeUnknownDetail: "La requête a peut-être été traitée et facturée. Le système ne renvoie pas automatiquement.",
      retry: "Relancer la couverture",
      retryTitle: "Relancer la couverture ?",
      retryBillingRisk: "Le résultat de l'exécution précédente est inconnu et a peut-être été facturé. Relancer crée une nouvelle exécution et peut facturer à nouveau.",
      retryConfirm: "Confirmer le relancement",
      retryCancel: "Annuler",
      retrying: "Relancement…",
      retryFailed: "Le relancement a échoué. Vérifiez l'erreur et réessayez.",
      fixedSnapshot: "Instantané des sources fixé à la soumission",
    ...
    globalModel: {
      ...
      unavailable: "Le modèle enregistré n'est pas disponible",
      selectModelHint: "Sélectionnez un modèle de recherche avant de générer.",
    ...
    searchContext: {
      label: "Contexte",
      save: "Enregistrer le contexte de recherche",
      saving: "Enregistrement…",
      autoAdjusted: "Le modèle actuel ne prend pas en charge le contexte {{level}} — bascule vers focused.",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "Couvrir toutes les sources sélectionnées n'est pas activé sur ce déploiement — la demande n'a pas été envoyée. Utilisez la réponse fondée sur les preuves pertinentes ou demandez à un administrateur de l'activer.",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "Voir le rapport",
    compareReportHide: "Masquer le rapport",
    compareReportLoading: "Chargement du rapport…",
    compareReportError: "Rapport non disponible pour le moment",
    ...
    workbench: {
      ...
      exportAll: "Exporter les artefacts de recherche",
      exportCreated: "Export créé",
      exportDownloading: "Téléchargement de l’export…",
      exportFailed: "Échec de l’export",
      empty: "Rien ici pour le moment",
      noteCreated: "Note créée",
      noteUpdated: "Note mise à jour",
      noteDeleted: "Note supprimée",
      insightCreated: "Information enregistrée",
      transformationCreated: "Modèle créé",
    },
    sources: {
      statusPending: "Synchronisation",
      statusReady: "Prêt",
    ...
    citation: {
      page: "Page {{page}}",
      jump: "Aller à la source",
      degradedSource: "Fichier source indisponible ; le texte original est conservé",
      degradedVersion: "Version référencée indisponible ; le texte original est conservé",
      degradedPage: "Page référencée indisponible ; le texte original est conservé",
    },
    notes: {
    ...
    insights: {
      newInsight: "Nouvelle information",
      typeLabel: "Type",
      typeManual: "Manuel",
      typeAi: "IA",
    ...
    transformations: {
      ...
      scopePrivate: "Privé au projet",
      scopeAdmin: "Modèle administrateur",
