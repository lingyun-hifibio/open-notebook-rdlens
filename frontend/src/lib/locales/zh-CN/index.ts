...
export const zhCN = {
  ...
  research: {
    ...
    coverage: {
      scopeLabel: "回答范围",
      scopeRelevant: "相关证据回答",
      scopeAllSelected: "覆盖全部所选来源",
      capabilityDisabled: "当前部署未启用「覆盖全部所选来源」。",
      ...
      analyzed: "已分析",
      failed: "失败",
      status: { complete: "完成", partial: "部分完成", failed: "失败" },
      perDocument: "逐来源状态",
      revision: "版本",
      verificationVerified: "已校验",
      verificationCriticIssues: "有评审问题",
      verificationDegraded: "降级",
      verificationLabel: "校验状态",
      criticIssuesCount: "{{count}} 个待评审问题",
      outcomeUnknown: "结果未知——需要人工处理",
      outcomeUnknownDetail: "请求可能已被模型处理并产生费用。系统不会自动重发。",
      retry: "重试覆盖任务",
      retryTitle: "重试覆盖任务？",
      retryBillingRisk: "上一次运行的结果未知，可能已产生费用。重试将创建新的运行，可能再次计费。",
      retryConfirm: "确认重试",
      retryCancel: "取消",
      retrying: "重试中…",
      retryFailed: "重试失败。请检查错误后重试。",
      fixedSnapshot: "提交时固定的来源快照",
      finalReport: "最终报告",
    },
    sourceChat: {
      title: "来源对话",
      ...
      send: "发送",
      placeholder: "就这篇来源提问……",
      emptyState: "开始针对该来源的对话。",
      retry: "重试",
      disconnected: "正在重连……（第 {{count}} 次）",
      conflictBusy: "该会话已有另一个请求在执行，请等待其完成后再重试。",
      errorGatewayUnavailable: "研究网关当前无法访问该来源，请稍后重试。",
      modeLabel: "模式",
      degradedBadge: "已降级",
      sourceVersionLabel: "来源版本",
    },
    layout: {
      resizeWorkspace: "调整研究面板大小",
      resizeSource: "调整来源面板大小",
      expandWorkspace: "展开任务工作区",
      expandSourceChat: "展开来源对话",
      restore: "恢复布局",
      artifacts: "研究产物",
      workspace: "任务工作区",
      sourceContent: "来源正文",
    ...
    searchRun: "搜索",
    searchRunning: "搜索中…",
    searchResolvedMode: "模式",
    searchEvidence: "证据",
    searchEvidenceList: "证据",
    searchDegradation: "已降级",
    previewTitle: "上下文预览",
    ...
    globalModel: {
      ...
      clear: "清除",
      saveFailed: "保存失败",
      unavailable: "已保存模型不可用",
      selectModelHint: "请先选择研究模型再执行生成。",
    ...
    searchContext: {
      ...
      save: "保存搜索上下文",
      saving: "保存中…",
      autoAdjusted: "当前模型不支持 {{level}} 上下文，已切换为 focused。",
    },
    citations: "引用",
    citationPage: "第",
    ...
    chatErrorCoverageNotEnabled: "当前部署未启用「覆盖全部所选来源」，请求未提交。请使用「相关证据回答」，或联系管理员启用该功能。",
    compareTitle: "对比文档",
    compareSelected: "已选",
    compareHardMax: "硬上限",
    compareCreate: "开始对比",
    compareCreating: "创建对比任务中…",
    compareReportView: "查看报告",
    compareReportHide: "收起报告",
    compareReportLoading: "报告加载中…",
    compareReportError: "报告暂不可读",
    ...
    workbench: {
      ...
      exportAll: "导出研究产物",
      exportCreated: "导出已创建",
      exportDownloading: "正在下载导出文件…",
      exportFailed: "导出失败",
      empty: "暂无内容",
      noteCreated: "笔记已创建",
      noteUpdated: "笔记已更新",
      noteDeleted: "笔记已删除",
      insightCreated: "洞察已保存",
      transformationCreated: "模板已创建",
    },
    sources: {
      statusPending: "同步中",
      statusReady: "就绪",
    ...
    citation: {
      page: "第 {{page}} 页",
      jump: "跳转到来源",
      degradedSource: "来源文件不可用，原文保留",
      degradedVersion: "引用版本已失效，原文保留",
      degradedPage: "引用页不可用，原文保留",
    },
    notes: {
      newNote: "新建笔记",
      titleLabel: "标题",
