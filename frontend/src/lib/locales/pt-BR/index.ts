...
export const ptBR = {
  ...
  research: {
    ...
    modelSelector: "Modelo",
    contextLevelSelector: "Contexto",
    savePreference: "Salvar preferência",
    savingPreference: "Salvando…",
    ...
    modelRequiredHint: "Selecione um modelo.",
    ...
    transformations: {
      ...
      citations: "Citações",
      egressTitle: "Aviso de transferência de dados",
      egressMessage: "Executar uma transformação envia as entradas selecionadas ao serviço de modelo configurado. O modelo pode ser um serviço externo; certifique-se de que foi aprovado pelo administrador.",
      confirmRun: "Executar",
    },
  },
