...
export const ptBR = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "Gerando resposta…",
    coverage: {
      scopeLabel: "Escopo da resposta",
      scopeRelevant: "Resposta com evidências relevantes",
      scopeAllSelected: "Cobrir todas as fontes selecionadas",
      capabilityDisabled: "Cobrir todas as fontes selecionadas não está habilitado nesta implantação.",
      notesNotSupported: "Cobrir todas as fontes selecionadas não é suportado para Notas nesta fase — desmarque as Notas para usar.",
      noSourcesHint: "Selecione pelo menos uma fonte.",
      entireProjectNotice: "Coverage runs on a selected Source set — switch to Selected sources to use it.",
      tooManySources: "No máximo {{max}} fontes podem ser cobertas ({{count}} selecionadas).",
      syncing: "Tarefa aceita — sincronizando status…",
      targetCoverage: "Cobertura alvo",
      requested: "Planejadas",
      analyzed: "Analisadas",
      failed: "Falhas",
      status: { complete: "Completa", partial: "Parcial", failed: "Falha" },
      perDocument: "Status por fonte",
      revision: "Revisão",
      verificationVerified: "Verificada",
      verificationCriticIssues: "Problemas de revisão",
      verificationDegraded: "Degradada",
      verificationLabel: "Verificação",
      criticIssuesCount: "{{count}} problema(s) para revisar",
      outcomeUnknown: "Resultado desconhecido — revisão manual necessária",
      outcomeUnknownDetail: "A solicitação pode ter sido processada e cobrada. O sistema não reenvia automaticamente.",
      retry: "Repetir cobertura",
      retryTitle: "Repetir a cobertura?",
      retryBillingRisk: "O resultado da execução anterior é desconhecido e pode ter sido cobrado. Repetir cria uma nova execução e pode cobrar novamente.",
      retryConfirm: "Confirmar repetição",
      retryCancel: "Cancelar",
      retrying: "Repetindo…",
      retryFailed: "A repetição falhou. Verifique o erro e tente novamente.",
      fixedSnapshot: "Snapshot fixo das fontes no envio",
    ...
    globalModel: {
      label: "Modelo da pesquisa",
      placeholder: "Selecione um modelo",
      save: "Salvar",
      saving: "Salvando…",
      clear: "Limpar",
      saveFailed: "Falha ao salvar",
      unavailable: "O modelo salvo está indisponível",
      selectModelHint: "Selecione um modelo de pesquisa antes de gerar.",
    ...
    searchContext: {
      label: "Contexto",
      save: "Salvar contexto de busca",
      saving: "Salvando…",
      autoAdjusted: "O modelo atual não suporta o contexto {{level}} — alterado para focused.",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "Cobrir todas as fontes selecionadas não está habilitado nesta implantação — a solicitação não foi enviada. Use a resposta com evidências relevantes ou peça a um administrador para habilitá-la.",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "Ver relatório",
    compareReportHide: "Ocultar relatório",
    compareReportLoading: "Carregando relatório…",
    compareReportError: "Relatório ainda não disponível",
    ...
    workbench: {
      ...
      actionFailed: "A operação falhou. Tente novamente.",
      loadFailed: "Falha ao carregar",
      exportAll: "Exportar artefatos de pesquisa",
      exportCreated: "Exportação criada",
      exportDownloading: "Baixando exportação…",
      exportFailed: "Falha na exportação",
      empty: "Nada aqui ainda",
      noteCreated: "Nota criada",
      noteUpdated: "Nota atualizada",
      noteDeleted: "Nota excluída",
      insightCreated: "Insight salvo",
      transformationCreated: "Modelo criado",
    },
    sources: {
    ...
    citation: {
      page: "Página {{page}}",
      jump: "Ir para a fonte",
      degradedSource: "Arquivo da fonte indisponível; o texto original é mantido",
      degradedVersion: "Versão referenciada não está mais disponível; o texto original é mantido",
      degradedPage: "Página referenciada indisponível; o texto original é mantido",
    },
    notes: {
      newNote: "Nova nota",
      titleLabel: "Título",
    ...
    transformations: {
      ...
      scopePrivate: "Privado do projeto",
      scopeAdmin: "Modelo de administrador",
      save: "Salvar modelo",
      run: "Executar",
