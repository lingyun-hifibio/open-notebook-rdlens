...
export const bnIN = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "উত্তর তৈরি হচ্ছে…",
    coverage: {
      scopeLabel: "উত্তরের পরিধি",
      scopeRelevant: "প্রাসঙ্গিক প্রমাণসহ উত্তর",
      scopeAllSelected: "নির্বাচিত সব উৎস কভার করুন",
      capabilityDisabled: "এই স্থাপনায় 'সব নির্বাচিত উৎস কভার' সক্রিয় নেই।",
      notesNotSupported: "এই পর্যায়ে নোটের জন্য 'সব নির্বাচিত উৎস কভার' সমর্থিত নয় — ব্যবহার করতে নোটের নির্বাচন বাতিল করুন।",
      noSourcesHint: "অন্তত একটি উৎস নির্বাচন করুন।",
      entireProjectNotice: "Coverage runs on a selected Source set — switch to Selected sources to use it.",
      tooManySources: "সর্বোচ্চ {{max}}টি উৎস কভার করা যাবে ({{count}}টি নির্বাচিত)।",
      syncing: "কাজ গৃহীত হয়েছে — অবস্থা সিঙ্ক হচ্ছে…",
      targetCoverage: "লক্ষ্য কভারেজ",
      requested: "পরিকল্পিত",
      analyzed: "বিশ্লেষিত",
      failed: "ব্যর্থ",
      status: { complete: "সম্পূর্ণ", partial: "আংশিক", failed: "ব্যর্থ" },
      perDocument: "উৎস অনুযায়ী অবস্থা",
      revision: "রিভিশন",
      verificationVerified: "যাচাইকৃত",
      verificationCriticIssues: "পর্যালোচনা সমস্যা",
      verificationDegraded: "অবনমিত",
      verificationLabel: "যাচাই",
      criticIssuesCount: "পর্যালোচনার জন্য {{count}}টি সমস্যা",
      outcomeUnknown: "ফলাফল অজানা — ম্যানুয়াল পর্যালোচনা প্রয়োজন",
      outcomeUnknownDetail: "অনুরোধটি প্রক্রিয়াকৃত ও বিল করা হয়ে থাকতে পারে। সিস্টেম স্বয়ংক্রিয়ভাবে আবার পাঠায় না।",
      retry: "কভারেজ পুনরায় চেষ্টা করুন",
      retryTitle: "কভারেজ পুনরায় চেষ্টা করবেন?",
      retryBillingRisk: "পূর্ববর্তী রানের ফলাফল অজানা এবং বিল করা হয়ে থাকতে পারে। পুনরায় চেষ্টা নতুন রান তৈরি করবে এবং আবার বিল করতে পারে।",
      retryConfirm: "পুনরায় চেষ্টা নিশ্চিত করুন",
      retryCancel: "বাতিল",
      retrying: "পুনরায় চেষ্টা হচ্ছে…",
      retryFailed: "পুনরায় চেষ্টা ব্যর্থ হয়েছে। ত্রুটি দেখে আবার চেষ্টা করুন।",
      fixedSnapshot: "জমার সময় নির্ধারিত উৎস স্ন্যাপশট",
      finalReport: "চূড়ান্ত প্রতিবেদন",
    },
    sourceChat: {
      title: "Source chat",
    ...
    globalModel: {
      label: "গবেষণা মডেল",
      placeholder: "একটি মডেল নির্বাচন করুন",
      save: "সংরক্ষণ",
      saving: "সংরক্ষণ হচ্ছে…",
      clear: "মুছে ফেলুন",
      saveFailed: "সংরক্ষণ ব্যর্থ",
      unavailable: "সংরক্ষিত মডেল অনুপলব্ধ",
      selectModelHint: "জেনারেট করার আগে একটি গবেষণা মডেল নির্বাচন করুন।",
    ...
    searchContext: {
      label: "প্রসঙ্গ",
      save: "অনুসন্ধান প্রসঙ্গ সংরক্ষণ",
      saving: "সংরক্ষণ হচ্ছে…",
      autoAdjusted: "বর্তমান মডেল {{level}} প্রসঙ্গ সমর্থন করে না — focused-এ স্যুইচ করা হয়েছে।",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "এই স্থাপনায় 'সব নির্বাচিত উৎস কভার' সক্রিয় নেই — অনুরোধটি জমা দেওয়া হয়নি। প্রাসঙ্গিক প্রমাণ-ভিত্তিক উত্তর ব্যবহার করুন বা একজন প্রশাসককে এটি সক্রিয় করতে বলুন।",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "View report",
    compareReportHide: "Hide report",
    compareReportLoading: "Loading report…",
    compareReportError: "Report is not available yet",
    ...
    workbench: {
      ...
      loadFailed: "লোড করা ব্যর্থ হয়েছে",
      exportAll: "গবেষণা আর্টিফ্যাক্ট রপ্তানি করুন",
      exportCreated: "রপ্তানি তৈরি হয়েছে",
      exportDownloading: "রপ্তানি ডাউনলোড হচ্ছে…",
      exportFailed: "রপ্তানি ব্যর্থ হয়েছে",
      empty: "এখনও কিছু নেই",
      noteCreated: "নোট তৈরি হয়েছে",
      noteUpdated: "নোট হালনাগাদ হয়েছে",
      noteDeleted: "নোট মুছে ফেলা হয়েছে",
      insightCreated: "অন্তর্দৃষ্টি সংরক্ষিত হয়েছে",
      transformationCreated: "টেমপ্লেট তৈরি হয়েছে",
    },
    sources: {
      statusPending: "সিংক্রোনাইজ হচ্ছে",
      ...
      empty: "কোনো উৎস নেই",
      open: "বিষয়বস্তু দেখুন",
      scopeSelect: "Include {{name}} in scope",
      back: "উৎস তালিকায় ফিরুন",
      chunkPage: "পৃষ্ঠা {{page}}",
    },
    citation: {
      page: "পৃষ্ঠা {{page}}",
      jump: "উৎসে যান",
      degradedSource: "উৎস ফাইল অনুপলব্ধ; মূল পাঠ্য সংরক্ষিত",
      degradedVersion: "উল্লেখিত সংস্করণ আর উপলব্ধ নেই; মূল পাঠ্য সংরক্ষিত",
      degradedPage: "উল্লেখিত পৃষ্ঠা অনুপলব্ধ; মূল পাঠ্য সংরক্ষিত",
    },
    notes: {
      newNote: "নতুন নোট",
      titleLabel: "শিরোনাম",
      ...
      edit: "সম্পাদনা",
      delete: "মুছে ফেলুন",
      confirmDelete: "এই নোটটি মুছে ফেলবেন?",
      search: "নোট খুঁজুন…",
      scopeSelect: "Include {{title}} in scope",
      empty: "কোনো নোট নেই",
    },
    insights: {
      newInsight: "নতুন অন্তর্দৃষ্টি",
      typeLabel: "ধরন",
      typeManual: "ম্যানুয়াল",
      typeAi: "এআই",
      empty: "কোনো অন্তর্দৃষ্টি নেই",
    ...
    transformations: {
      ...
      nameLabel: "নাম",
      promptLabel: "প্রম্পট টেমপ্লেট",
      scopePrivate: "প্রকল্প-ব্যক্তিগত",
      scopeAdmin: "প্রশাসক টেমপ্লেট",
      save: "টেমপ্লেট সংরক্ষণ",
      run: "চালান",
