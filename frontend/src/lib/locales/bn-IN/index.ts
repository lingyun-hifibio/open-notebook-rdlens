...
export const bnIN = {
  ...
  research: {
    ...
    modelSelector: "মডেল",
    contextLevelSelector: "প্রসঙ্গ",
    savePreference: "অগ্রাধিকার সংরক্ষণ",
    savingPreference: "সংরক্ষণ করা হচ্ছে…",
    ...
    modelRequiredHint: "একটি মডেল নির্বাচন করুন।",
    ...
    transformations: {
      ...
      citations: "উদ্ধৃতি",
      egressTitle: "ডেটা বহির্গমন বিজ্ঞপ্তি",
      egressMessage: "রূপান্তর চালালে নির্বাচিত ইনপুট কনফিগার করা মডেল সার্ভিসে পাঠানো হয়। মডেলটি বাহ্যিক সার্ভিস হতে পারে; নিশ্চিত করুন এটি প্রশাসক-অনুমোদিত।",
      confirmRun: "চালান",
    },
  },
