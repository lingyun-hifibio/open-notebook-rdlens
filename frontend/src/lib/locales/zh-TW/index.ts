...
export const zhTW = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "正在生成答案…",
    coverage: {
      scopeLabel: "回答範圍",
      scopeRelevant: "相關證據回答",
      scopeAllSelected: "覆蓋全部所選來源",
      capabilityDisabled: "目前部署未啟用「覆蓋全部所選來源」。",
      ...
      analyzed: "已分析",
      failed: "失敗",
      status: { complete: "完成", partial: "部分完成", failed: "失敗" },
      perDocument: "逐來源狀態",
      revision: "版本",
      verificationVerified: "已校驗",
      verificationCriticIssues: "有審查問題",
      verificationDegraded: "降級",
      verificationLabel: "校驗狀態",
      criticIssuesCount: "{{count}} 個待審查問題",
      outcomeUnknown: "結果未知——需要人工處理",
      outcomeUnknownDetail: "請求可能已被模型處理並產生費用。系統不會自動重發。",
      retry: "重試覆蓋任務",
      retryTitle: "重試覆蓋任務？",
      retryBillingRisk: "上一次執行的結果未知，可能已產生費用。重試將建立新的執行，可能再次計費。",
      retryConfirm: "確認重試",
      retryCancel: "取消",
      retrying: "重試中…",
      retryFailed: "重試失敗。請檢查錯誤後重試。",
      fixedSnapshot: "提交時固定的來源快照",
      finalReport: "最終報告",
    },
    sourceChat: {
      title: "Source chat",
    ...
    coverageReport: "覆蓋範圍",
    consentTitle: "外部模型外发确认",
    consentIntro: "首次在本文档库使用外部模型前，请确认以下外发范围：",
    ...
    globalModel: {
      ...
      clear: "清除",
      saveFailed: "儲存失敗",
      unavailable: "已儲存的模型不可用",
      selectModelHint: "請先選擇研究模型再執行生成。",
    ...
    searchContext: {
      ...
      save: "儲存搜尋上下文",
      saving: "儲存中…",
      autoAdjusted: "目前模型不支援 {{level}} 上下文，已切換為 focused。",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "目前部署未啟用「覆蓋全部所選來源」，請求未提交。請使用「相關證據回答」，或聯絡管理員啟用該功能。",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "查看報告",
    compareReportHide: "收起報告",
    compareReportLoading: "報告載入中…",
    compareReportError: "報告暫不可讀",
    ...
    workbench: {
      ...
      exportAll: "匯出研究產物",
      exportCreated: "匯出已建立",
      exportDownloading: "正在下載匯出檔案…",
      exportFailed: "匯出失敗",
      empty: "暫無內容",
      noteCreated: "筆記已建立",
      noteUpdated: "筆記已更新",
      noteDeleted: "筆記已刪除",
      insightCreated: "洞察已儲存",
      transformationCreated: "範本已建立",
    },
    sources: {
      statusPending: "同步中",
      statusReady: "就緒",
    ...
    citation: {
      page: "第 {{page}} 頁",
      jump: "跳轉到來源",
      degradedSource: "來源檔案不可用，原文保留",
      degradedVersion: "引用版本已失效，原文保留",
      degradedPage: "引用頁不可用，原文保留",
    },
    notes: {
      newNote: "新增筆記",
      titleLabel: "標題",
