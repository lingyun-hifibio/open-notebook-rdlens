...
export const trTR = {
  ...
  research: {
    ...
    modelSelector: "Model",
    contextLevelSelector: "Bağlam",
    savePreference: "Tercihi kaydet",
    savingPreference: "Kaydediliyor…",
    ...
    modelRequiredHint: "Bir model seçin.",
    ...
    transformations: {
      ...
      citations: "Alıntılar",
      egressTitle: "Veri aktarım bildirimi",
      egressMessage: "Dönüşümü çalıştırmak, seçilen girdileri yapılandırılmış model hizmetine gönderir. Model harici bir hizmet olabilir; yönetici onayından geçtiğinden emin olun.",
      confirmRun: "Çalıştır",
    },
  },
