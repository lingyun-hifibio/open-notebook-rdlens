...
export const esES = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "Generando respuesta…",
    coverage: {
      scopeLabel: "Alcance de la respuesta",
      scopeRelevant: "Respuesta con evidencia relevante",
      scopeAllSelected: "Cubrir todas las fuentes seleccionadas",
      capabilityDisabled: "Cubrir todas las fuentes seleccionadas no está habilitado en esta implementación.",
      notesNotSupported: "Cubrir todas las fuentes seleccionadas no está disponible para Notas en esta fase — deseleccione las Notas para usarlo.",
      noSourcesHint: "Seleccione al menos una fuente.",
      entireProjectNotice: "Coverage runs on a selected Source set — switch to Selected sources to use it.",
      tooManySources: "Se pueden cubrir como máximo {{max}} fuentes ({{count}} seleccionadas).",
      syncing: "Tarea aceptada — sincronizando estado…",
      targetCoverage: "Cobertura objetivo",
      requested: "Planificado",
      analyzed: "Analizadas",
      failed: "Fallidas",
      status: { complete: "Completo", partial: "Parcial", failed: "Fallido" },
      perDocument: "Estado por fuente",
      revision: "Revisión",
      verificationVerified: "Verificado",
      verificationCriticIssues: "Problemas de revisión",
      verificationDegraded: "Degradado",
      verificationLabel: "Verificación",
      criticIssuesCount: "{{count}} problema(s) a revisar",
      outcomeUnknown: "Resultado desconocido — se requiere revisión manual",
      outcomeUnknownDetail: "La solicitud puede haber sido procesada y facturada. El sistema no reenvía automáticamente.",
      retry: "Reintentar cobertura",
      retryTitle: "¿Reintentar la cobertura?",
      retryBillingRisk: "El resultado de la ejecución anterior es desconocido y puede haberse facturado. Reintentar crea una nueva ejecución y puede facturar de nuevo.",
      retryConfirm: "Confirmar reintento",
      retryCancel: "Cancelar",
      retrying: "Reintentando…",
      retryFailed: "El reintento falló. Compruebe el error e inténtelo de nuevo.",
      fixedSnapshot: "Instantánea fija de fuentes al enviar",
    ...
    globalModel: {
      label: "Modelo de investigación",
      placeholder: "Seleccione un modelo",
      save: "Guardar",
      saving: "Guardando…",
      clear: "Borrar",
      saveFailed: "Error al guardar",
      unavailable: "El modelo guardado no está disponible",
      selectModelHint: "Seleccione un modelo de investigación antes de generar.",
    ...
    searchContext: {
      label: "Contexto",
      save: "Guardar contexto de búsqueda",
      saving: "Guardando…",
      autoAdjusted: "El modelo actual no admite el contexto {{level}}; se ha cambiado a focused.",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "Cubrir todas las fuentes seleccionadas no está habilitado en esta implementación — la solicitud no se envió. Use la respuesta con evidencia relevante o pida a un administrador que la habilite.",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "Ver informe",
    compareReportHide: "Ocultar informe",
    compareReportLoading: "Cargando informe…",
    compareReportError: "El informe aún no está disponible",
    ...
    workbench: {
      ...
      actionFailed: "La operación falló. Inténtelo de nuevo.",
      loadFailed: "Error al cargar",
      exportAll: "Exportar artefactos de investigación",
      exportCreated: "Exportación creada",
      exportDownloading: "Descargando exportación…",
      exportFailed: "Error en la exportación",
      empty: "Nada aquí todavía",
      noteCreated: "Nota creada",
      noteUpdated: "Nota actualizada",
      noteDeleted: "Nota eliminada",
      insightCreated: "Información guardada",
      transformationCreated: "Plantilla creada",
    },
    sources: {
      statusPending: "Sincronizando",
      statusReady: "Listo",
      ...
      chunkPage: "Página {{page}}",
    },
    citation: {
      page: "Página {{page}}",
      jump: "Ir a la fuente",
      degradedSource: "Archivo de fuente no disponible; se conserva el texto original",
      degradedVersion: "La versión referenciada ya no está disponible; se conserva el texto original",
      degradedPage: "La página referenciada no está disponible; se conserva el texto original",
    },
    notes: {
      newNote: "Nueva nota",
      titleLabel: "Título",
    ...
    transformations: {
      ...
      scopePrivate: "Privado del proyecto",
      scopeAdmin: "Plantilla de administrador",
