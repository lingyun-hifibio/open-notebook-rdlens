...
export const esES = {
  ...
  research: {
    ...
    modelRequiredHint: "Selecciona un modelo.",
    ...
    transformations: {
      ...
      citations: "Citas",
      egressTitle: "Aviso de transferencia de datos",
      egressMessage: "Ejecutar una transformación envía las entradas seleccionadas al servicio de modelo configurado. El modelo puede ser un servicio externo; asegúrese de que esté aprobado por el administrador.",
      confirmRun: "Ejecutar",
    },
  },
