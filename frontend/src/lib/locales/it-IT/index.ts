...
export const itIT = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "Generazione della risposta…",
    coverage: {
      scopeLabel: "Ambito della risposta",
      scopeRelevant: "Risposta con evidenze pertinenti",
      scopeAllSelected: "Copri tutte le fonti selezionate",
      capabilityDisabled: "Coprire tutte le fonti selezionate non è abilitato in questa distribuzione.",
      notesNotSupported: "Coprire tutte le fonti selezionate non è supportato per le Note in questa fase — deseleziona le Note per usarlo.",
      noSourcesHint: "Seleziona almeno una fonte.",
      entireProjectNotice: "Coverage runs on a selected Source set — switch to Selected sources to use it.",
      tooManySources: "È possibile coprire al massimo {{max}} fonti ({{count}} selezionate).",
      syncing: "Attività accettata — sincronizzazione dello stato…",
      targetCoverage: "Copertura obiettivo",
      requested: "Previste",
      analyzed: "Analizzate",
      failed: "Non riuscite",
      status: { complete: "Completa", partial: "Parziale", failed: "Non riuscita" },
      perDocument: "Stato per fonte",
      revision: "Revisione",
      verificationVerified: "Verificata",
      verificationCriticIssues: "Problemi di revisione",
      verificationDegraded: "Degradata",
      verificationLabel: "Verifica",
      criticIssuesCount: "{{count}} problema/i da rivedere",
      outcomeUnknown: "Esito sconosciuto — revisione manuale richiesta",
      outcomeUnknownDetail: "La richiesta potrebbe essere stata elaborata e fatturata. Il sistema non invia automaticamente di nuovo.",
      retry: "Riprova copertura",
      retryTitle: "Riprovare la copertura?",
      retryBillingRisk: "L'esito dell'esecuzione precedente è sconosciuto e potrebbe essere stato fatturato. Riprovare crea una nuova esecuzione e può fatturare di nuovo.",
      retryConfirm: "Conferma nuovo tentativo",
      retryCancel: "Annulla",
      retrying: "Nuovo tentativo…",
      retryFailed: "Nuovo tentativo non riuscito. Controlla l'errore e riprova.",
      fixedSnapshot: "Snapshot fisso delle fonti al momento dell'invio",
    ...
    globalModel: {
      label: "Modello di ricerca",
      placeholder: "Seleziona un modello",
      save: "Salva",
      saving: "Salvataggio…",
      clear: "Cancella",
      saveFailed: "Salvataggio non riuscito",
      unavailable: "Il modello salvato non è disponibile",
      selectModelHint: "Seleziona un modello di ricerca prima di generare.",
    ...
    searchContext: {
      label: "Contesto",
      save: "Salva contesto di ricerca",
      saving: "Salvataggio…",
      autoAdjusted: "Il modello attuale non supporta il contesto {{level}} — impostato su focused.",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "Coprire tutte le fonti selezionate non è abilitato in questa distribuzione — la richiesta non è stata inviata. Usa la risposta basata su prove pertinenti o chiedi a un amministratore di abilitarla.",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "Visualizza rapporto",
    compareReportHide: "Nascondi rapporto",
    compareReportLoading: "Caricamento rapporto…",
    compareReportError: "Rapporto non ancora disponibile",
    ...
    workbench: {
      ...
      exportAll: "Esporta gli artefatti di ricerca",
      exportCreated: "Esportazione creata",
      exportDownloading: "Download dell’esportazione…",
      ...
      insightCreated: "Approfondimento salvato",
      transformationCreated: "Modello creato",
    },
    sources: {
      statusPending: "Sincronizzazione",
      statusReady: "Pronto",
      ...
      empty: "Nessuna fonte",
      open: "Visualizza contenuto",
      scopeSelect: "Include {{name}} in scope",
      back: "Torna alle fonti",
      chunkPage: "Pagina {{page}}",
    },
    citation: {
      page: "Pagina {{page}}",
      jump: "Vai alla fonte",
      degradedSource: "File della fonte non disponibile; il testo originale è conservato",
      degradedVersion: "Versione referenziata non più disponibile; il testo originale è conservato",
      degradedPage: "Pagina referenziata non disponibile; il testo originale è conservato",
    },
    notes: {
      newNote: "Nuova nota",
      titleLabel: "Titolo",
    ...
    insights: {
      newInsight: "Nuovo approfondimento",
      typeLabel: "Tipo",
      typeManual: "Manuale",
      typeAi: "IA",
      empty: "Nessun approfondimento",
    },
    transformations: {
      newTemplate: "Nuovo modello",
      nameLabel: "Nome",
      promptLabel: "Modello di prompt",
      scopePrivate: "Privato del progetto",
      scopeAdmin: "Modello amministratore",
      save: "Salva modello",
      run: "Esegui",
