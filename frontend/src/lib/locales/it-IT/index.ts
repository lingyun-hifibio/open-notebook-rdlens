...
export const itIT = {
  ...
  research: {
    ...
    modelSelector: "Modello",
    contextLevelSelector: "Contesto",
    savePreference: "Salva preferenza",
    savingPreference: "Salvataggio…",
    ...
    modelRequiredHint: "Seleziona un modello.",
    ...
    transformations: {
      ...
      citations: "Citazioni",
      egressTitle: "Avviso di trasferimento dati",
      egressMessage: "L’esecuzione invia gli input selezionati al servizio di modello configurato. Il modello può essere un servizio esterno; assicurarsi che sia approvato dall’amministratore.",
      confirmRun: "Esegui",
    },
  },
