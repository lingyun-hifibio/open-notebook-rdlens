export const enUS = {
  ...
  research: {
    ...
    modelRequiredHint: "Select a model to run.",
    ...
    transformations: {
      ...
      citations: "Citations",
      egressTitle: "Data egress notice",
      egressMessage: "Running a transformation sends the selected inputs to the configured model service. The model may be an external service; make sure it is administrator-approved.",
      confirmRun: "Run",
    },
  },
}
