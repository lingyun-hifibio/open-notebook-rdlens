export const enUS = {
  ...
  research: {
    ...
    layout: {
      ...
      chat: "Chat",
      scope: {
        modeLabel: "Research scope",
        entireProject: "Entire project",
        selected: "Selected sources and notes",
        selectedSummary: "Selected: {{sources}} sources, {{notes}} notes",
        selectItemRequired: "Select a source or note to use a selected scope.",
        editScope: "Edit scope",
        reconciled: "Scope updated because unavailable items were removed.",
      },
    },
    ...
    globalModel: {
      ...
      unavailable: "Saved model is unavailable",
      selectModelHint: "Select a research model before generating.",
    ...
    searchContext: {
      label: "Context",
      save: "Save search context",
      saving: "Saving…",
      autoAdjusted: "The current model does not support the {{level}} context — switched to focused.",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "Coverage of all selected sources is not enabled on this deployment — the request was not submitted. Use the relevant evidence answer or ask an administrator to enable it.",
    ...
    chatThinkingNotice: "Generating answer...",
    coverage: {
      scopeLabel: "Answer scope",
      scopeRelevant: "Relevant evidence answer",
      scopeAllSelected: "Cover all selected sources",
      capabilityDisabled: "Coverage of all selected sources is not enabled on this deployment.",
      ...
      perDocument: "Per-source status",
      revision: "Revision",
      verificationVerified: "Verified",
      verificationCriticIssues: "Review issues",
      verificationDegraded: "Degraded",
      verificationLabel: "Verification",
      criticIssuesCount: "{{count}} issue(s) to review",
      outcomeUnknown: "Outcome unknown — manual review required",
      outcomeUnknownDetail: "The request may have been processed by the model and billed. The system will not resend automatically.",
      retry: "Retry coverage",
      retryTitle: "Retry coverage task?",
      retryBillingRisk: "The previous run's outcome is unknown and may have been billed. Retrying creates a new run and may bill again.",
      retryConfirm: "Confirm retry",
      retryCancel: "Cancel",
      retrying: "Retrying…",
      retryFailed: "Retry failed. Check the error and try again.",
    ...
    workbench: {
      ...
      exportAll: "Export research artifacts",
      exportCreated: "Export created",
      exportDownloading: "Downloading export…",
      exportFailed: "Export failed",
      empty: "Nothing here yet",
      noteCreated: "Note created",
      noteUpdated: "Note updated",
      noteDeleted: "Note deleted",
      insightCreated: "Insight saved",
      transformationCreated: "Template created",
    },
    sources: {
    ...
    citation: {
      page: "Page {{page}}",
      jump: "Jump to source",
      degradedSource: "Source file unavailable; original text is retained",
      degradedVersion: "Referenced version is no longer available; original text is retained",
      degradedPage: "Referenced page unavailable; original text is retained",
    },
    notes: {
      newNote: "New note",
      titleLabel: "Title",
    ...
    transformations: {
      ...
      scopePrivate: "Project private",
      scopeAdmin: "Admin template",
      save: "Save template",
      run: "Run",
