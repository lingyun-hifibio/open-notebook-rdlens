...
export const ruRU = {
  ...
  research: {
    ...
    layout: {
      ...
      projectScope: "Scope: entire project (automatic retrieval)",
      selectedScope: "Scope: {{sources}} sources, {{notes}} notes",
    },
    noProjectContext: "Research session is missing project context.",
