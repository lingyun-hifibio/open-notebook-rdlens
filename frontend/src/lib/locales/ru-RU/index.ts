...
export const ruRU = {
  ...
  research: {
    ...
    contextLevelSelector: "Контекст",
    savePreference: "Сохранить предпочтение",
    savingPreference: "Сохранение…",
    ...
    modelRequiredHint: "Выберите модель.",
    ...
    transformations: {
      ...
      citations: "Цитаты",
      egressTitle: "Уведомление о передаче данных",
      egressMessage: "Запуск преобразования отправляет выбранные входные данные настроенному сервису модели. Модель может быть внешним сервисом; убедитесь, что она одобрена администратором.",
