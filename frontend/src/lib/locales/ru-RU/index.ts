...
export const ruRU = {
  ...
  research: {
    ...
    layout: {
      ...
      content: "Content",
      chat: "Chat",
      scope: { modeLabel: "Research scope", entireProject: "Entire project", selected: "Selected sources and notes", selectedSummary: "Selected: {{sources}} sources, {{notes}} notes", selectItemRequired: "Select a source or note to use a selected scope.", editScope: "Edit scope" },
    },
