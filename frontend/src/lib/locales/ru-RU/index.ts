...
export const ruRU = {
  ...
  research: {
    ...
    },    chatThinkingNotice: "Формирование ответа…",
    coverage: {
      scopeLabel: "Область ответа",
      scopeRelevant: "Ответ по релевантным доказательствам",
      scopeAllSelected: "Охватить все выбранные источники",
      capabilityDisabled: "Охват всех выбранных источников не включён в этом развёртывании.",
      notesNotSupported: "Охват всех выбранных источников не поддерживается для заметок на этом этапе — снимите выбор заметок, чтобы использовать его.",
      noSourcesHint: "Выберите хотя бы один источник.",
      entireProjectNotice: "Coverage runs on a selected Source set — switch to Selected sources to use it.",
      tooManySources: "Можно охватить не более {{max}} источников (выбрано {{count}}).",
      syncing: "Задача принята — синхронизация состояния…",
      targetCoverage: "Целевой охват",
      requested: "Запланировано",
      analyzed: "Проанализировано",
      failed: "Сбой",
      status: { complete: "Полный", partial: "Частичный", failed: "Сбой" },
      perDocument: "Статус по источникам",
      revision: "Ревизия",
      verificationVerified: "Проверено",
      verificationCriticIssues: "Замечания рецензии",
      verificationDegraded: "Понижено",
      verificationLabel: "Проверка",
      criticIssuesCount: "{{count}} замечание(й) для проверки",
      outcomeUnknown: "Результат неизвестен — требуется ручная проверка",
      outcomeUnknownDetail: "Запрос мог быть обработан и оплачен. Система не отправляет повторно автоматически.",
      retry: "Повторить охват",
      retryTitle: "Повторить охват?",
      retryBillingRisk: "Результат предыдущего запуска неизвестен и мог быть оплачен. Повтор создаст новый запуск и может быть оплачен снова.",
      retryConfirm: "Подтвердить повтор",
      retryCancel: "Отмена",
      retrying: "Повтор…",
      retryFailed: "Не удалось повторить. Проверьте ошибку и попробуйте снова.",
      fixedSnapshot: "Снимок источников, зафиксированный при отправке",
    ...
    previewTitle: "Предпросмотр контекста",
    previewDirectHint: "По оценке, поместится в прямой запрос.",
    previewJobHint: "Слишком велико для прямого запроса — будет выполнено как фоновое задание.",
    backgroundQueued: "Поставлено в очередь как фоновое задание; ход выполнения — в списке исследовательских заданий.",
    resultModel: "Модель",
    resultLevel: "Контекст",
    usageEstimatedBadge: "оценка",
    ...
    globalModel: {
      label: "Модель исследования",
      placeholder: "Выберите модель",
      save: "Сохранить",
      saving: "Сохранение…",
      clear: "Очистить",
      saveFailed: "Не удалось сохранить",
      unavailable: "Сохранённая модель недоступна",
      selectModelHint: "Выберите модель исследования перед запуском генерации.",
    ...
    searchContext: {
      label: "Контекст",
      save: "Сохранить контекст поиска",
      saving: "Сохранение…",
      autoAdjusted: "Текущая модель не поддерживает контекст {{level}} — переключено на focused.",
    },
    citations: "Citations",
    citationPage: "p.",
    ...
    chatErrorCoverageNotEnabled: "Охват всех выбранных источников не включён в этом развёртывании — запрос не был отправлен. Используйте ответ по релевантным доказательствам или попросите администратора включить эту возможность.",
    compareTitle: "Compare documents",
    compareSelected: "Selected",
    compareHardMax: "Hard max",
    compareCreate: "Start compare",
    compareCreating: "Creating compare job…",
    compareReportView: "Показать отчёт",
    compareReportHide: "Скрыть отчёт",
    compareReportLoading: "Загрузка отчёта…",
    compareReportError: "Отчёт пока недоступен",
    ...
    loading: "Загрузка исследовательского пространства…",
    ...
    workbench: {
      ...
      actionFailed: "Операция не удалась. Попробуйте ещё раз.",
      loadFailed: "Не удалось загрузить",
      exportAll: "Экспортировать исследовательские артефакты",
      exportCreated: "Экспорт создан",
      exportDownloading: "Загрузка экспорта…",
      ...
      insightCreated: "Инсайт сохранён",
      transformationCreated: "Шаблон создан",
    },
    sources: {
      statusPending: "Синхронизация",
      statusReady: "Готово",
      ...
      open: "Просмотреть содержимое",
      scopeSelect: "Include {{name}} in scope",
      back: "Назад к источникам",
      chunkPage: "Стр. {{page}}",
    },
    citation: {
      page: "Стр. {{page}}",
      jump: "Перейти к источнику",
      degradedSource: "Файл источника недоступен; исходный текст сохранён",
      degradedVersion: "Указанная версия больше недоступна; исходный текст сохранён",
      degradedPage: "Указанная страница недоступна; исходный текст сохранён",
    },
    notes: {
    ...
    transformations: {
      ...
      scopePrivate: "Приватно проекта",
      scopeAdmin: "Шаблон администратора",
